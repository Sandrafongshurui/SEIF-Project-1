...
class MaintenenceCalculatedNutrients {
    constructor(goal) {
        this.goal = goal
...
class GoalCalculatedNutrients extends MaintenenceCalculatedNutrients {
...
// export { MaintenenceCalculatedNutrients }
// export { GoalCalculatedNutrients }

//testing
MaintenenceCalculatedNutrients.printNUm(5)
MaintenenceCalculatedNutrients.num
GoalCalculatedNutrients.num